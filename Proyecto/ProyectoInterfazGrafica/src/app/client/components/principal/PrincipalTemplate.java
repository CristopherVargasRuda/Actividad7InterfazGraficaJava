...
public class PrincipalTemplate extends JPanel {
    ...
    private void crearJLabels() {
        ...
        lSuperior = sObjGraficos.construirJLabel(null, 0, 0, 910, 230, iDimAux, null, null, null);
        ...
        lTetaneitor = sObjGraficos.construirJLabel(null, 0, 55, 250, 200, iDimAux, null, null, null);
