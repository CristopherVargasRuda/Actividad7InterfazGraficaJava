...
public class NavegacionUsuarioTemplate extends JPanel{
    ...
    public void crearJLabels(){
        ...
        this.lMain = sObjGraficos.construirJLabel(
            "MAIN", 15, 5, 30, 20, null, sRecursos.getColorNav(), null, fontAuxiliar
        );
        this.pMedio.add(lMain);
        
        // LABEL YOUR MUSIC--------------------------------------------------------------------
        this.lYourMusic = sObjGraficos.construirJLabel(
            "YOUR MUSIC", 15, 5, 70, 20, null, sRecursos.getColorNav(), null, fontAuxiliar
        );
        ...
        this.lSpotify = sObjGraficos.construirJLabel(
            null, 18, (pSuperior.getHeight()-45)/2+15, 45, 45, iDimAux, null, null, null
        );
